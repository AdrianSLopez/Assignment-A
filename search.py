...
# TODO:
    # For every algorith switch goal state to perferct puzzle
...
# TODO 
# Add puzzle to node and update it
...
# Compare currentNode's puzzle to goal puzzle return true or false if match
def matchGoalState(currentNode):
